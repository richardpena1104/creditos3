...
Route::middleware('auth')->group(function (){
	...
	Route::middleware('ability:Administrador|Master|Gerente,admin-users|administrator')->group(function (){
		 ...
		 * Users
		*/
		Route::resource('users', 'UserController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master,admin-users|administrator']]);
		Route::get('users', 'UserController@index')->name('users.index');
	});

	Route::get('user/profile', 'UserController@profile')->name('user.profile');

	Route::middleware('ability:Administrador|Master|Gerente,admin-clients|administrator')->group(function (){
		/**
		 * ClientTypes
		 */
		Route::resource('clientTypes', 'ClientTypeController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master,admin-clients|administrator']]);

		Route::get('clientTypes', 'ClientTypeController@index')->name('clientTypes.index');
		/**
		 * Clients
		 */
		Route::get('clients/get/{query}', 'ClientController@get')->name('clients.get');
		Route::resource('clients', 'ClientController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master,admin-clients|administrator']]);
		Route::get('clients/create', 'ClientController@create', ['middleware' => ['ability:Administrador|Master,admin-clients|administrator']])->name('clients.create');
	...
	Route::middleware('ability:Administrador|Master|Gerente,admin-products|administrator')->group(function (){
		/**
		 * Categories
		 */
		...
		Route::resource('products', 'ProductController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master,admin-products|administrator']]);
		/**
		 * Bands
		 */
	...
	Route::middleware('ability:Administrador|Master|Gerente|Vendedor,admin-sales|administrator')->group(function (){
		 ...
		 * Sales
		 */
		Route::resource('sales', 'SaleController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master|Vendedor,admin-sales|administrator']]);
		...
		*/
		...
		Route::resource('invoices', 'InvoiceController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master|Vendedor,admin-sales|administrator']]);
		 ...
		 * Taxes
		 */
		Route::resource('taxes', 'TaxController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master|Vendedor,admin-sales|administrator']]);
	...
	Route::middleware('ability:Administrador|Master|Gerente|Vendedor,admin-credits|administrator')->group(function (){
		...
		Route::resource('credits', 'CreditController', ['except' => ['index'], 'middleware' => ['ability:Administrador|Master|Vendedor,admin-credits|administrator']]);
...
Route::get('products/get/{query}', 'ProductController@get')->name('products.get');
Route::resource('products', 'ProductController');

Route::get('changePrice', 'ProductController@changePrice')->name('changePrice');
...
Route::get('/stores/get', 'StoreController@getStores');
Route::post('/stores/transfer', 'StoreController@transfer')->name('stores.transfer');
...
Route::post('sales/finished/{id}', 'SaleController@finished')->name('sales.finished');
...
Route::get('prueba', 'ProductController@productDatatable');
